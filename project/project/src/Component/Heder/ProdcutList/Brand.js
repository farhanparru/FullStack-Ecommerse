...
const Brand = () => {
  return (
    <div>
      <div class="container">
  <h2>India Number One Brands Company</h2>
  <ul class="cards">
    <li class="Prodect-Card">
      <div>
        <h3 class="card-title">Windows  </h3>
        <div class="card-content">
        <p style={{fontStyle:'normal', fontSize:"1.5rem,lineheigth:2rem"}}>Microsoft Corporation is an American multinational technology corporation headquartered in Redmond, Washington. Microsoft's best-known software products are the Windows line of operating</p>
    ...
    <li class="Prodect-Card">
      <div>
        ...
        <div class="card-content">
          <p style={{fontStyle:'normal', fontSize:"1.5rem,lineheigth:2rem"}}>Dell sells personal computers PCs, servers, data storage devices, network switches, software, computer peripherals, HDTVs, cameras, printers, and electronics</p>
        </div>
    ...
    <li class="Prodect-Card">
      <div>
        ...
        <div class="card-content">
          <p style={{fontStyle:'normal', fontSize:"1.5rem,lineheigth:2rem"}}>Steve Jobs was a charismatic pioneer of the personal computer era. With Steve Wozniak, Jobs founded Apple</p>
        </div>
